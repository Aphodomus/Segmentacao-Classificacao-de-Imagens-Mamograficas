...
# Form implementation generated from reading ui file './new_sidebar.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icon/icon/drag-gray.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon.addPixmap(QtGui.QPixmap(":/icon/icon/drag-white.ico"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icon/icon/zoom-gray.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon1.addPixmap(QtGui.QPixmap(":/icon/icon/zoom-white.ico"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        ...
        icon2.addPixmap(QtGui.QPixmap(":/icon/close-window-64.ico"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/icon/icon/3643772-archive-archives-document-folder-open_113445.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.full_menu_widget.setMaximumSize(QtCore.QSize(121, 16777215))
        ...
        self.label_min = QtWidgets.QLabel(self.full_menu_widget)
        self.label_min.setObjectName("label_min")
        self.horizontalLayout_5.addWidget(self.label_min)
        self.verticalLayout_4.addLayout(self.horizontalLayout_5)
        self.verticalLayout_7.addLayout(self.verticalLayout_4)
        self.horizontalSlider_min = QtWidgets.QSlider(self.full_menu_widget)
        self.horizontalSlider_min.setMaximumSize(QtCore.QSize(96, 16777215))
        self.horizontalSlider_min.setMaximum(255)
        self.horizontalSlider_min.setPageStep(1)
        self.horizontalSlider_min.setOrientation(QtCore.Qt.Horizontal)
        self.horizontalSlider_min.setTickInterval(1)
        self.horizontalSlider_min.setObjectName("horizontalSlider_min")
        self.verticalLayout_7.addWidget(self.horizontalSlider_min)
        ...
        self.label_max = QtWidgets.QLabel(self.full_menu_widget)
        self.label_max.setObjectName("label_max")
        self.horizontalLayout_7.addWidget(self.label_max)
        self.verticalLayout_7.addLayout(self.horizontalLayout_7)
        self.horizontalSlider_max = QtWidgets.QSlider(self.full_menu_widget)
        self.horizontalSlider_max.setMaximumSize(QtCore.QSize(96, 16777215))
        self.horizontalSlider_max.setMaximum(253)
        self.horizontalSlider_max.setPageStep(1)
        self.horizontalSlider_max.setOrientation(QtCore.Qt.Horizontal)
        self.horizontalSlider_max.setTickInterval(1)
        self.horizontalSlider_max.setObjectName("horizontalSlider_max")
        self.verticalLayout_7.addWidget(self.horizontalSlider_max)
        spacerItem4 = QtWidgets.QSpacerItem(17, 484, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_min.setText(_translate("MainWindow", "0"))
